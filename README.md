...
![Portfolio Preview Stella Maris Loreto](assets/Nportfolio.JPG)
...
- **CSS3** (Arquitectura modular, Flexbox, Grid)
- **JavaScript** (Lógica de notificacion)
- **EmailJS** (Integración de formulario de contacto sin backend)
- **FontAwesome** (Iconografía)
- **Google Fonts** (Tipografía Poppins)

## 📱 Enfoque Responsive

Como futura QA, puse especial énfasis en la compatibilidad multidispositivo, testeando específicamente en:

- **Desktop:** 1440px - 1280px
- **Tablet:** 768px
- **Mobile:** 480px y **360px** (específico para dispositivos compactos).
